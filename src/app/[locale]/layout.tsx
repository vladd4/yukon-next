...
export const metadata: Metadata = {
  ...
  description:
    "Дистриб`ютор продуктів швидкого споживання в Україні з великим досвідом на ринку. Наша мета - забезпечити швидке сполучення покупця і виробника, надаючи широкий асортимент і високий рівень сервісу. Дистриб`ютор продуктів Ковель, Волинська область.",
  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <meta
          name="google-site-verification"
          content="ZJIkzj94ddvUJSXPXLaFBDMyDnvUufeEZ255PP4Xq7s"
        />
        <meta
          name="viewport"
